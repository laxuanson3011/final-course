...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand my-logo pr-2" href="index.php">ADMIN</a>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="<?php echo URL_ADMIN; ?>users/new.php">Tạo mới Users</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="<?php echo URL_ADMIN; ?>products/new.php">Tạo mới Products</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="<?php echo URL_ADMIN; ?>catalogs/new.php">Tạo mới Catalogs</a>
          </div>
        </li>
        <li class="nav-item dropdown">
